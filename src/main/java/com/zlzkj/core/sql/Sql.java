...
public class Sql{
	...
	public static Sql get(Class<?> poClass){
		return new Sql(poClass);
	}
	 ...
	 * @return
	 */
	public Sql fields(String... fieldsArr){
	 ...
	 * @return
	 */
	public Sql where(Map<String, Object> where,String... logicType){
	 ...
	 * @return
	 */
	public Sql where(String where,String... logicType){
	 ...
	 * @return
	 */
	public Sql order(String orderField, String orderType){
	 ...
	 * @return
	 */
	public Sql page(Integer page,Integer rows){
	 ...
	 * @param pageMap
	 */
	public Sql parseUIPageAndOrder(Map<String,String> pageMap){
	 ...
	 * @return
	 */
	public Sql join(Class<?> anotherPoClass,String joinFieldString){
	 ...
	 * @return
	 */
	public Sql join(Class<?> anotherPoClass,String joinFieldString,String joinType){
		String pojoNameString= getPojoName();
		String simpleName = anotherPoClass.getSimpleName();
		String anotherName = simpleName;
		if (anotherName.equals(pojoNameString)) {  //判断是否于原类同名
	...
	public String parseTableName(Class<?> poClass){
		...
		if(table == null){ //实体类不存在table注解则自动按规则解析表名
			InputStream in = Sql.class.getResourceAsStream("/jdbc.properties");
